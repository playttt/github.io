...
var args10749 = [];
var len__5726__auto___10753 = arguments.length;
var i__5727__auto___10754 = (0);
while(true){
if((i__5727__auto___10754 < len__5726__auto___10753)){
args10749.push((arguments[i__5727__auto___10754]));

var G__10755 = (i__5727__auto___10754 + (1));
i__5727__auto___10754 = G__10755;
continue;
} else {
}
break;
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4425__auto___10757 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__10748_SHARP_){
if(!((p1__10748_SHARP_ == null))){
if((false) || (p1__10748_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
var not_reactive_10758 = temp__4425__auto___10757;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_10758);
} else {
}
} else {
}
...
//# sourceMappingURL=subs.js.map?rel=1464143787479