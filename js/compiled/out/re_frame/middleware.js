...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__10800){
...
return cljs.core.get_in.call(null,new_db,p1__10801_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__10802_SHARP_){
return cljs.core.get_in.call(null,db,p1__10802_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__10803__i < G__10803__a.length) {G__10803__a[G__10803__i] = arguments[G__10803__i + 2]; ++G__10803__i;}
  in_paths = new cljs.core.IndexedSeq(G__10803__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__10804){
var f = cljs.core.first(arglist__10804);
arglist__10804 = cljs.core.next(arglist__10804);
var out_path = cljs.core.first(arglist__10804);
var in_paths = cljs.core.rest(arglist__10804);
...
//# sourceMappingURL=middleware.js.map?rel=1464143787637