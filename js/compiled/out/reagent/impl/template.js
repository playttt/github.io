...
var G__10605 = o;
(G__10605[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_10609 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_10609))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_10609)].join(''):class$));
} else {
}
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10610_SHARP_);
...
var vec__10614 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10614,(0),null);
var id = cljs.core.nth.call(null,vec__10614,(1),null);
var class$ = cljs.core.nth.call(null,vec__10614,(2),null);
...
var temp__4427__auto__ = (function (){var G__10618 = cljs.core.meta.call(null,v);
var G__10618__$1 = (((G__10618 == null))?null:reagent.impl.template.get_key.call(null,G__10618));
return G__10618__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__10620_10621 = v;
var G__10620_10622__$1 = (((G__10620_10621 == null))?null:reagent.impl.template.key_from_vec.call(null,G__10620_10621));
var G__10620_10623__$2 = (((G__10620_10622__$1 == null))?null:(jsprops["key"] = G__10620_10622__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__10626 = cljs.core.meta.call(null,argv);
var G__10626__$1 = (((G__10626 == null))?null:reagent.impl.template.get_key.call(null,G__10626));
return G__10626__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__10627 = (((jsprops == null))?{}:jsprops);
(G__10627["key"] = key);
...
var G__10628 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__10628;
continue;
}
} else {
...
var n__5571__auto___10629 = a.length;
var i_10630 = (0);
while(true){
if((i_10630 < n__5571__auto___10629)){
(a[i_10630] = reagent.impl.template.as_element.call(null,(a[i_10630])));

var G__10631 = (i_10630 + (1));
i_10630 = G__10631;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__5571__auto___10632 = a.length;
var i_10633 = (0);
while(true){
if((i_10633 < n__5571__auto___10632)){
var val_10634 = (a[i_10633]);
if((cljs.core.vector_QMARK_.call(null,val_10634)) && ((reagent.impl.template.key_from_vec.call(null,val_10634) == null))){
(o["no-key"] = true);
} else {
}

(a[i_10633] = reagent.impl.template.as_element.call(null,val_10634));

var G__10635 = (i_10633 + (1));
i_10633 = G__10635;
continue;
} else {
}
...
var G__10637 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10637) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__10637){
...
//# sourceMappingURL=template.js.map?rel=1464143787208