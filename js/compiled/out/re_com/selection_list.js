...
var i__5727__auto___12035 = (0);
while(true){
if((i__5727__auto___12035 < len__5726__auto___12034)){
args12031.push((arguments[i__5727__auto___12035]));

var G__12036 = (i__5727__auto___12035 + (1));
i__5727__auto___12035 = G__12036;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args12031.length)].join('')));
...
var base_style__$1 = (cljs.core.truth_((function (){var and__4656__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__4656__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__4656__auto__)){
...
if(cljs.core.truth_((function (){var and__4656__auto__ = required_QMARK_;
if(cljs.core.truth_(and__4656__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__12041){
var map__12044 = p__12041;
var map__12044__$1 = ((((!((map__12044 == null)))?((((map__12044.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12044.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12044):map__12044);
var args = map__12044__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__12044__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__12044__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__12044__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__12044__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__12044__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__12044__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__12044__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__12044__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__12044__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__12044__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__12044__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__12044,map__12044__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__12038_SHARP_){
return item_renderer.call(null,p1__12038_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__12044,map__12044__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__12044,map__12044__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__12039_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__12039_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__12044,map__12044__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__12044,map__12044__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__12040_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__12040_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__12044,map__12044__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
args__5733__auto__.push((arguments[i__5727__auto___12054]));
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__5734__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__12047){
var map__12048 = p__12047;
var map__12048__$1 = ((((!((map__12048 == null)))?((((map__12048.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12048.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12048):map__12048);
var args = map__12048__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"validate-args-macro","validate-args-macro",-1576181756,null),new cljs.core.Symbol(null,"selection-list-args-desc","selection-list-args-desc",-219283300,null),new cljs.core.Symbol(null,"args","args",-1338879193,null),"selection-list")))].join('')));
}

return ((function (map__12048,map__12048__$1,args){
return (function() { 
var G__12056__delegate = function (p__12050){
var map__12051 = p__12050;
var map__12051__$1 = ((((!((map__12051 == null)))?((((map__12051.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12051.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12051):map__12051);
var args__$1 = map__12051__$1;
...
while (G__12057__i < G__12057__a.length) {G__12057__a[G__12057__i] = arguments[G__12057__i + 0]; ++G__12057__i;}
  p__12050 = new cljs.core.IndexedSeq(G__12057__a,0);
} 
return G__12056__delegate.call(this,p__12050);};
G__12056.cljs$lang$maxFixedArity = 0;
G__12056.cljs$lang$applyTo = (function (arglist__12058){
var p__12050 = cljs.core.seq(arglist__12058);
return G__12056__delegate(p__12050);
});
G__12056.cljs$core$IFn$_invoke$arity$variadic = G__12056__delegate;
return G__12056;
})()
;
;})(map__12048,map__12048__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq12046){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12046));
});

//# sourceMappingURL=selection_list.js.map?rel=1464143790728